...
class OllamaService:
    ...
    def _generate_raw(self, prompt: str, system: str = "", json_mode: bool = False, keep_alive: str | None = None, options: dict | None = None) -> dict:
    ...
    def generate(self, prompt: str, system: str = "", json_mode: bool = False, keep_alive: str | None = None, options: dict | None = None) -> str:
        return self._generate_raw(prompt, system, json_mode, keep_alive, options)["response"]
    def generate_raw(self, prompt: str, system: str = "", json_mode: bool = False, keep_alive: str | None = None, options: dict | None = None) -> dict:
        ...
        return self._generate_raw(prompt, system, json_mode, keep_alive, options)
